...
if(isset($_POST['submit']))
{
	...
	{
		$sql1="select * from appoinment where time='$time'";
 ...
 $sql="insert into appoinment(id,patient_name,doc_name,phone_no,symptoms,avail_date,time)values($id,'$pat_name','$docname','$phn','$symptoms','$date','$time')";
