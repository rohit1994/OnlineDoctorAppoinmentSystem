...
if(isset($_POST['submit']))
{
 ...
 $sql="insert into users(name,email,mobile,type,qualification,specialization,experience,cladd,id_proof,id_no,username,password)values
 ('$name','$mobile','$email','$type','$qualification','$specilization','$experience','$cladd','$id_proof','$id_no','$username','$pswd1')";
