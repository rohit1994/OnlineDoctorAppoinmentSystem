...
if(isset($_POST['submit']))
{
 ...
 $sql="insert into users(name,type,age,email,mobile,gender,address,id_proof,id_no,username,password)values('$name','$type','$age','$email','$phn','$gender','$address','$ID','$IDN','$uname','$pswd1')";
